...
class SettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $settings = [
            ...
            // Editable "pitch" panel shown beside the donation form.
            ['key' => 'offering_pitch_eyebrow', 'group' => 'offerings', 'value' => 'Générosité'],
            ['key' => 'offering_pitch_title', 'group' => 'offerings', 'value' => 'Semer pour la moisson'],
            ['key' => 'offering_pitch_quote', 'group' => 'offerings', 'value' => "« Que chacun donne comme il l'a résolu dans son cœur, avec joie. »"],
            ['key' => 'offering_pitch_reference', 'group' => 'offerings', 'value' => '2 Corinthiens 9.7'],
            ['key' => 'offering_pitch_points', 'group' => 'offerings', 'value' => [
