...
Route::prefix('v1')
    // The whole church API is tenant-scoped: the tenant is resolved from the
    // request Host, the connection/storage are switched to it, central domains
    // are refused, and a lapsed/suspended tenant is turned away (CHR-137).
    ->middleware([
    ...
    ->group(function (): void {
        ...
        Route::prefix('admin')->name('api.v1.admin.')->group(function (): void {
            ...
            Route::middleware('auth:sanctum')->group(function (): void {
                ...
                // Custom-domain onboarding (CHR-148). Adding a domain needs the
                // `custom_domain` feature; the rest is settings-level.
