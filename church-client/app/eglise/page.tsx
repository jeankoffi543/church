...
import { Flame, ArrowRight, ShieldCheck, HeartHandshake, Compass, Users2 } from "lucide-react";
  ...
  return (
    <section className="min-h-screen bg-cream px-6 pt-[clamp(96px,11vw,120px)] pb-[90px]">
      <div className="mx-auto max-w-[1100px]">
        ...
        <div className="mb-16 rounded-3xl border border-[rgba(40,25,80,0.08)] bg-white p-6 shadow-[0_24px_50px_rgba(22,15,51,0.04)] md:p-8 flex flex-col md:flex-row gap-6 items-center">
