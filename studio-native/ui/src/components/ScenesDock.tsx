...
import type { StudioScene } from "../lib/api";

const MONO = "font-studio-mono";

/**
 * Dock 1 · Scenes — ported 1:1 from the web console's `scenes-dock.tsx`. Click a
 * scene to switch the Preview + inspector; drag to reorder; double-click the name
 * to rename; the cross removes it. Data wired to our studio store commands.
 */
          ...
          return (
            ...
            >
              ...
              <span className="min-w-0 flex-1">
                ...
                <span className="mt-0.5 block text-[9.5px] text-white/40">{sc.layers.length} source(s)</span>
              </span>
